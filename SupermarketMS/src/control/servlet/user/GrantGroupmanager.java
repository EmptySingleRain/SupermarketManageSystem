...
public class GrantGroupmanager extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<HTML>");
		out.println("  <HEAD><TITLE>赋予组别控制器</TITLE></HEAD>");
		out.println("  <BODY bgcolor='#e6f1fc'>");
		
        try {   

          user.setUsername(request.getParameter("yhm").trim());
          user.setGroupname(request.getParameter("zb").trim());
          ...
          response.addHeader("refresh","5;url=\"../admin/groupmanager/GrantGroupmanager.jsp\"");    

          out.print("赋予组别成功！<br>若5秒未跳转，请点击<a href=../admin/groupmanager/GrantGroupmanager.jsp>跳转至当前页面</a>");
