...
<html>
  ...
  <body>
		...
		<form  method="post" action="servlet/MallLogin?origin=malllogin" class="form center">
		<div class="login">
		...
		<footer>
			...
			<div class="copyright">ZEROLIGHT版权所有-沪ICP备10000001-<img src="./image/ghs.png" alt="">沪公网安备11010802020134号-沪ICP证110507号</div>
