...
window.onload=function()
  ...
  <label>添加员工</label>
      <form name="tianjia" action="servlet/InsertStuff" method="post" onsubmit="return checkForma();">
        <table border="1" class="table">
          <tr><th>用户名:</th><td style="width: 180px"><input type="text" name="yhm"/></td><td style="width: 80px"><span id="msg">请输入用户名</span></td></tr>
          ...
          <tr><th>性别:</th><td colspan="2"><a>男</a><input type="radio" name="xb" value="男" checked=true/>  &nbsp;  <a>女</a><input type="radio" name="xb" value="女" /></tr>
         ...
         <!-- <tr><th>注册日期:</th><td colspan="2"><input type="date" name="zcrq" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%>" disabled/></td></tr> -->
          ...
          <tr><th>员工组别:</th><td colspan="2"><a>收银员</a><input type="radio" name="zb" value="收银员" checked=true/>  &nbsp;  <a>仓管员</a><input type="radio" name="zb" value="仓管员" /></tr>
